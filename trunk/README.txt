...
Website:
http://code.google.com/p/phproxyimproved/

Support:
http://code.google.com/p/phproxyimproved/issues/list
...
PHProxy improved is a web HTTP proxy 
designed to bypass proxy restrictions through
a web interface very similar to the popular CGIProxy 
(http://www.jmarshall.com/tools/cgiproxy/). For example, in many 
universities or schools, the IT department blocks a lot of harmless 
websites simply because of their popularity (like facebook). 
So you can use this porgram to access those websites. The only thing that 
PHProxy needs is a web server with PHP installed (see Requirements below).
...
your own risk. We will not be responsible for any damages done or any
...
Abdullah Ari (http://whitefyre.com/) for the software PHProxy. This 
software ist based on his work. The readme is based on his one, too.
...
Last original Source Code Version 0.5b2 - January 20th 2007
